...
{
    public class CopyFinancials : WebApiActivityBase
    {
        [RequiredArgument]
        [Input("CVR")]
        ...
        public override void Execute(CodeActivityContext activityContext, IWorkflowContext workflowContext, IOrganizationService organizationService, ITracingService tracingService)
        {
            ...
            {
                new FinancialManager(organizationService).CopyFinancials(companyid, cvr, baseUrl, accessToken, baseLanguage, country);
            } 
        }
    }
}
